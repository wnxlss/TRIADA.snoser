...
bot_token = '8226545963:AAEM5KLfo30GncqujiLXYYxvtb5u6fNCdp0'
admin_chat_ids = ['7910618692']  # Добавьте сюда ID всех администраторов 'id', 'id' и тд
CRYPTO_PAY_TOKEN = '514407:AAYmqI3VxJYnDiKplzJSS3ZX1wOWDsIhtxD' # тут замените на свой api от бота @send
